...
| **P2** | Typo-noise eval axis | **done and run** — light/moderate 16/16, heavy 9/16, **0 invariant violations at every level** (EVAL.md §5b) | Very cheap, and it tests the channel this product actually has |
